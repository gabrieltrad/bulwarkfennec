...
["<t size = '.5'>Criando base...</t>", 0, 0, 30, 0] remoteExec ["BIS_fnc_dynamicText", 0];
_basepoint = [] execVM "bulwark\createBase.sqf";
waitUntil { scriptDone _basepoint };

["<t size = '.5'>Ready to go!</t>", 0, 0, 0.5, 0] remoteExec ["BIS_fnc_dynamicText", 0];
