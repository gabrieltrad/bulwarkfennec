...
BULWARK_SUPPORTITEMS = [
	...
	[15000, "Reviver TODOS", 			"reviveall",  8016, 1]
];
...
BUILDITEMS = [
	...
	[7000, "Ammo Truck",		   "CUP_B_T810_Reammo_CZ_WDL", 		   90, 3.5, false, 4],
	[5000, "Fuel Truck", 			"C_Van_01_fuel_f", 				    90,  4, false, 4],
	...
	[1000, "H-Barrier (4 Big)",    "Land_HBarrierBig_F",                0, 4.5, false, 1],
