...
BUILDITEMS = [
    ...
    [10,   "Road Barrier",	       "RoadBarrier_F",                     0,   1, false, 1],
    [10,   "Road Barrier (Small)", "RoadBarrier_small_F",               0,  .5, false, 1],
    [25,   "Long Plank (8m)",      "Land_Plank_01_8m_F",                0,   4, false, 1],
    [50,   "Junk Barricade",       "Land_Barricade_01_4m_F",            0, 1.5, false, 1],
    [75,   "Small Ramp (1m)",      "Land_Obstacle_Ramp_F",            180, 1.5, false, 1],
	[50,   "Wood Wall (Short)",    "Land_Shoot_House_Wall_Crouch_F",    0, 1.2, false, 2],
    [100,  "Wood Wall (Tall)",     "Land_Shoot_House_Wall_F",           0, 1.2, false, 2],
	...
	[10,   "Sandbag (End)",	       "Land_BagFence_End_F",          		0,   1, false, 2],
	[25,   "Sandbag (Corner)",	   "Land_BagFence_Corner_F",            0,   1, false, 2],
    [45,   "Sandbag (Short)",      "Land_BagFence_Short_F",             0,   1, false, 2],
	[65,   "Sandbag (Long)",       "Land_BagFence_Long_F",              0,   2, false, 2],
    [65,   "Sandbag (Round)",      "Land_BagFence_Round_F",           180,   2, false, 2],
	[100,  "Short Sandbag Wall",   "Land_SandbagBarricade_01_half_F",   0, 1.5, false, 2],
    [150,  "Sandbag Wall",         "Land_SandbagBarricade_01_F",        0, 1.5, false, 2],
    [150,  "Sandbag Window",       "Land_SandbagBarricade_01_hole_F",   0, 1.5, false, 2],
	[50,   "Concrete Barrier",     "Land_CncBarrier_F",                 0, 1.2, false, 1],
    [165,  "Concrete Wall (Med)",  "Land_CncBarrierMedium_F",           0, 1.2, false, 2],
	[850,  "Concrete Wall (Tall)", "Land_CncWall1_F",                   0,   1, false, 2],
	[1000, "Concrete Platform",    "BlockConcrete_F",                   0, 3.5, false, 2],
    [180,  "Concrete Shelter",     "Land_CncShelter_F",                 0,   1, false, 2],
    [200,  "Concrete Walkway",     "Land_GH_Platform_F",                0, 3.5, false, 0],
    [250,  "Tall Concrete Wall",   "Land_Mil_WallBig_4m_F",             0,   2, false, 2],
    [225,  "Corner Military Wall", "Land_Mil_WallBig_Corner_F",         0, 1.2, false, 2],
    [260,  "Portable Light",       "Land_PortableLight_double_F",     180,   1, false, 0],
    [300,  "Long Concrete Wall",   "Land_CncBarrierMedium4_F",          0,   3, false, 2],
	[1500,  "Mounted DShK",         "CUP_O_DSHKM_ChDKZ", 				0, 0.5, false, 4],
	[2000, 	"Static HMG",          "B_HMG_01_high_F",          			0, 0.5, false, 4],
    [2000, 	"Static GMG",          "B_GMG_01_high_F",          			0, 0.5, false, 4],
	...
	[165,  "H-Barrier (Single)",   "Land_HBarrier_1_F",                 0,   1, false, 2],
    [500,  "H-Barrier (3 Long)",   "Land_HBarrier_3_F",                 0,   2, false, 2],
    [625,  "H-Barrier (5 Long)",   "Land_HBarrier_5_F",                 0,   3, false, 2],
	[1150, "H-Barrier (4 Big)",    "Land_HBarrierBig_F",                0, 4.5, false, 2],
