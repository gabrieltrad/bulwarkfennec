...
[bulwarkBox, ["<t color='#00ffff'>" + "Levar Bulwark", "bulwark\moveBox.sqf","",1,false,false,"true","true",2.5]] remoteExec ["addAction", 0, true];
[bulwarkBox, ["<t color='#00ff00'>" + "Shopee", "[] spawn bulwark_fnc_purchaseGuiNew; ShopCaller = _this select 1", "",1.5, false,false, "true", "true", 2.5]] remoteExec ["addAction", 0, true];																																					   
...
[bulwarkBox, ["ContainerOpened", {
	...
	["<t size = '.5'>Place 10 FAKs into the Bulwark to convert them into a Medikit</t>", 0, 1, 60, 0] remoteExec ["BIS_fnc_dynamicText", _playerId];
